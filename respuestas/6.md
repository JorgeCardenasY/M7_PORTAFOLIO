...
A continuación se describe cómo la aplicación Django creada implementa operaciones CRUD (Crear, Leer, Actualizar, Eliminar) utilizando el patrón Modelo-Vista-Template (MVT).
